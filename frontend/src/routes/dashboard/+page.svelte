...
<div class="max-w-5xl">
	...
	<div class="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
		<div class="rounded-xl border border-surface-200/60 bg-white p-5 shadow-sm dark:border-surface-800 dark:bg-surface-900">
		...
		<div class="rounded-xl border border-surface-200/60 bg-white p-5 shadow-sm dark:border-surface-800 dark:bg-surface-900">
			...
			<p class="mt-1 text-2xl font-bold text-primary-600 dark:text-primary-400">{projects.length}</p>
		</div>
		<div class="rounded-xl border border-surface-200/60 bg-white p-5 shadow-sm dark:border-surface-800 dark:bg-surface-900">
	...
	{#if projects.length === 0}
		<div class="rounded-xl border border-dashed border-surface-200 py-16 text-center dark:border-surface-800">
			<svg class="mx-auto h-12 w-12 text-surface-700/30 dark:text-surface-200/20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1">
				<path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12.75V12A2.25 2.25 0 0 1 4.5 9.75h15A2.25 2.25 0 0 1 21.75 12v.75m-8.69-6.44-2.12-2.12a1.5 1.5 0 0 0-1.061-.44H4.5A2.25 2.25 0 0 0 2.25 6v12a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18V9a2.25 2.25 0 0 0-2.25-2.25h-5.379a1.5 1.5 0 0 1-1.06-.44Z" />
			</svg>
			<p class="mt-4 text-sm text-surface-700/60 dark:text-surface-200/40">No projects yet. Create your first one!</p>
		</div>
	{:else}
			...
			{#each projects as project (project.id)}
				...
				>
					<div class="mb-3 flex items-start justify-between">
						<div class="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-primary-400 to-primary-600 text-sm font-bold text-white">
