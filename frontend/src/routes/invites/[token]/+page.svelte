...
>
	<div class="w-full max-w-md text-center">
		<div
			class="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-primary-500 to-primary-700 text-2xl font-bold text-white shadow-xl shadow-primary-500/25"
		>
			N
		</div>
			...
			{:else}
				...
				{#if !$userStore}
					...
					<div class="space-y-3">
						<a
							href="/login"
							class="flex w-full items-center justify-center rounded-lg bg-gradient-to-r from-primary-500 to-primary-600 px-4 py-3 text-sm font-semibold text-white shadow-lg transition-all hover:from-primary-600 hover:to-primary-700"
						>
							Log In
						</a>
						<a
							href="/register"
							class="flex w-full items-center justify-center rounded-lg border-2 border-primary-500 bg-transparent px-4 py-2.5 text-sm font-semibold text-primary-600 transition-all hover:bg-primary-50 dark:hover:bg-primary-900/20"
						>
							Create Account
						</a>
					</div>
