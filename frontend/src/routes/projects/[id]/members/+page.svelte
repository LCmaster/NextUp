	...
	{:else if project}
		...
		<div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
			<div class="lg:col-span-2">
				<!-- Members List -->
				<div
					class="rounded-xl border border-surface-200/60 bg-white shadow-sm dark:border-surface-800 dark:bg-surface-900"
				>
						...
						{#each members as member}
							<li class="flex items-center justify-between px-6 py-4">
								<div class="flex items-center gap-3">
									<div
										class="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-primary-400 to-primary-600 text-sm font-bold text-white"
									>
								...
								<div class="flex items-center gap-3">
									...
									{:else}
										<span
											class="inline-flex items-center rounded-md px-2.5 py-1 text-sm font-medium capitalize
											{member.role === 'owner'
						...
						>
							...
							<ul class="space-y-3">
								{#each invites as invite}
									<li
										class="flex items-center justify-between rounded-lg border border-surface-100 bg-surface-50 p-3 dark:border-surface-700/50 dark:bg-surface-800/50"
									>
										<div class="overflow-hidden">
											<p
												class="truncate text-sm font-medium text-surface-900 dark:text-white"
												title={invite.email}
											>
												{invite.email}
											</p>
