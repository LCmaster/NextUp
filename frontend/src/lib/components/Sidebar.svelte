...
>
	...
	<nav class="flex-1 overflow-y-auto px-3 py-4">
		<div
			class="mb-2 px-3 text-xs font-semibold uppercase tracking-wider text-surface-700/60 dark:text-surface-200/40"
		>
			Menu
		</div>
		...
		{#if projects.length > 0}
			<div
				class="mb-2 mt-6 px-3 text-xs font-semibold uppercase tracking-wider text-surface-700/60 dark:text-surface-200/40"
			>
				Projects
			</div>
			...
			<div class="flex items-center gap-3">
				...
				<div class="flex items-center gap-1">
					<button
						...
						title="Toggle theme"
						class="flex-shrink-0 rounded-md p-1.5 text-surface-700/50 transition-colors hover:bg-surface-200/50 hover:text-surface-900 dark:text-surface-200/40 dark:hover:bg-surface-800/50 dark:hover:text-white"
					>
						{#if $themeStore === 'dark'}
							<svg
								class="h-4 w-4"
